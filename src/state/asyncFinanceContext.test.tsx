...
const gateway = (load: FinanceGateway['load']): FinanceGateway => ({ load, addTransaction: vi.fn().mockResolvedValue(transaction), addManualAccount: vi.fn(), addManualCreditCard: vi.fn(), createGoal: vi.fn(), addGoalFunds: vi.fn() })
