...
export class GoalsRepository {
  ...
  private mapGoal(goal: any): GoalView {
    return {
      ...
      userId: goal.userId,
      name: goal.name,
      targetMinor: String(goal.targetMinor),
      currentMinor: String(goal.currentMinor),
      ...
      monthlyContributionMinor: goal.monthlyContributionMinor == null ? null : String(goal.monthlyContributionMinor),
      status: goal.status,
      active: goal.active,
