...
export function SyncCenter() {
  ...
  const discardOperation = (operation: SyncOutboxOperation) => {
    if (!window.confirm('Discard this local operation? It will not be posted to the ledger.')) return
    void localFirstStore.removeOperation(operation.operationId).then(refresh)
  }
