import { z } from 'zod';
import { accountTypeSchema, minorUnitTransportInput } from '../ledger/ledger.schemas.js';
...
export const createAccountSchema = z.object({
  ...
  openingBalanceMinor: minorUnitTransportInput.default(0n),
...
export const createCreditCardSchema = z.object({
  ...
  creditLimitMinor: minorUnitTransportInput.pipe(z.bigint().positive()),
  dueDay: z.number().int().min(1).max(31),
  minimumPaymentMinor: minorUnitTransportInput.default(0n),
});
